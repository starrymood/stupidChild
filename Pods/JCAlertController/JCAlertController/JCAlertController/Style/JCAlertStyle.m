...
- (void)useDefaultStyle {
    ...
    content.textColor = JCColor(51, 51, 51);
    ...
    buttonNormal.textColor = JCColor(78, 210, 106);
    buttonNormal.backgroundColor = [UIColor whiteColor];
    buttonNormal.highlightTextColor = JCDefaultTextColor;
    buttonNormal.highlightBackgroundColor = JCColor(78, 210, 106);
    ...
    buttonCancel.textColor = JCColor(51, 51, 51);
    buttonCancel.backgroundColor = [UIColor whiteColor];
    buttonCancel.highlightTextColor = JCColor(51, 51, 51);
