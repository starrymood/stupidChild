//
//  BGPendingReceiveViewController.m
//  shzTravelC
//
...
@interface BGPendingReceiveViewController ()<UITableViewDataSource,UITableViewDelegate>
...
@implementation BGPendingReceiveViewController
-(UIView *)noneView {
    if (!_noneView) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.sureBtnClicked = ^{   // 确认收货
        weakSelf.alert = [JCAlertController alertWithTitle:@"提示" message:@"确定已收到货物"];
