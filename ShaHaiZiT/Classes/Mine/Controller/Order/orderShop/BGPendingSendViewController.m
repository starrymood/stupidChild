...
@interface BGPendingSendViewController ()<UITableViewDataSource,UITableViewDelegate>
...
@implementation BGPendingSendViewController
-(UIView *)noneView {
    if (!_noneView) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    __weak __typeof(self) weakSelf = self;
    cell.sureBtnClicked = ^{    // 提醒发货
        weakSelf.alert = [JCAlertController alertWithTitle:@"提示" message:@"确定提醒发货"];
