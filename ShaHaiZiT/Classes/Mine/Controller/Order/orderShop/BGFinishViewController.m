...
@interface BGFinishViewController ()<UITableViewDataSource,UITableViewDelegate>
...
@implementation BGFinishViewController
-(UIView *)noneView {
    if (!_noneView) {
...
- (void)loadData {
    ...
    [param setObject:@"5" forKey:@"status"];
