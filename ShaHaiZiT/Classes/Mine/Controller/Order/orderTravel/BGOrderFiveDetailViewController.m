//
//  BGOrderFiveDetailViewController.m
//  ShaHaiZiT
//
...
@interface BGOrderFiveDetailViewController ()
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *contentCenterY;
@property (weak, nonatomic) IBOutlet UILabel *orderNumLabel;
@property (weak, nonatomic) IBOutlet UILabel *dateLabel;
@property (weak, nonatomic) IBOutlet UILabel *destinationLabel;
@property (weak, nonatomic) IBOutlet UILabel *travelPrivateLabel;
@property (weak, nonatomic) IBOutlet UILabel *foodPrivateLabel;
@property (weak, nonatomic) IBOutlet UILabel *stayPrivateLabel;
...
@implementation BGOrderFiveDetailViewController
...
-(void)updateSubViewsWithModel:(BGOrderDetailModel *)model{
    ...
    self.travelPrivateLabel.text = model.travel_preference;
    self.foodPrivateLabel.text = model.food_preference;
    self.stayPrivateLabel.text = model.room_preference;
