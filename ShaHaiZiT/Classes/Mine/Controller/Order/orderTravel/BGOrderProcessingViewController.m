//
//  BGOrderProcessingViewController.m
//  ShaHaiZiT
//
...
@interface BGOrderProcessingViewController ()<UITableViewDataSource,UITableViewDelegate>
...
@implementation BGOrderProcessingViewController
...
- (void)loadData {
    ...
    [param setObject:@"1" forKey:@"order_status"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.firstBtnClicked = ^{  // 发私聊
         if (model.product_set_cd.intValue == 6) {
             ...
             weakSelf.conversationVC.conversationType = ConversationType_PRIVATE;
             weakSelf.conversationVC.targetId = model.guide_rong_id;
             weakSelf.conversationVC.title = model.guide_name;
             [self.navigationController pushViewController:weakSelf.conversationVC animated:YES];
         }
        
    };
    cell.secondBtnClicked = ^{
