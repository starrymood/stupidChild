//
//  BGOrderThreeDetailViewController.m
//  ShaHaiZiT
//
...
@interface BGOrderThreeDetailViewController ()
...
@implementation BGOrderThreeDetailViewController
...
-(void)loadSubViews{
    self.navigationItem.title = @"按天包车";
