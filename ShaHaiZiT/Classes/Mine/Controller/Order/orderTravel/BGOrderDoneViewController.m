...
@interface BGOrderDoneViewController ()<UITableViewDataSource,UITableViewDelegate>
...
@implementation BGOrderDoneViewController
...
- (void)loadData {
    ...
    [param setObject:@"3" forKey:@"order_status"];
