//
//  BGOrderTwoDetailViewController.m
//  ShaHaiZiT
//
...
@interface BGOrderTwoDetailViewController ()
...
@implementation BGOrderTwoDetailViewController
...
-(void)updateSubViewsWithModel:(BGOrderDetailModel *)model{
    ...
    self.originLabel.text = model.departure;
    self.destinationLabel.text = model.airport_name;
