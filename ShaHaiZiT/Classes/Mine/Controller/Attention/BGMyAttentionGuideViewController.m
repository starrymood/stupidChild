//
//  BGMyAttentionGuideViewController.m
//  ShaHaiZiT
//
...
#define BtnHeight 56
@interface BGMyAttentionGuideViewController ()<UITableViewDelegate, UITableViewDataSource>
...
@implementation BGMyAttentionGuideViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([Tool arrayIsNotEmpty:_cellDataArr]) {
        ...
        [cell updataWithArray:model listType:3];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    conversationVC.targetId = model.rong_cloud_guide;
