...
@interface BGMyRecommendViewController ()<UITableViewDelegate, UITableViewDataSource>
...
@implementation BGMyRecommendViewController
...
-(void)loadData {
    ...
    [BGSystemApi getMyRecommendList:param  succ:^(NSDictionary *response) {
        DLog(@"\n>>>[getMyRecommendList sucess]:%@",response);
        ...
        DLog(@"\n>>>[getMyRecommendList failure]:%@",response);
