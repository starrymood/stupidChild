//
//  BGCouponExpiredViewController.m
//  shzTravelC
//
...
#define BtnHeight 40
@interface BGCouponExpiredViewController ()<UITableViewDelegate, UITableViewDataSource>
...
@implementation BGCouponExpiredViewController
-(UIView *)noneView {
    if (!_noneView) {
        ...
        showMsgLabel.text = @"亲，您还没有已过期的优惠券哟~";
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([Tool arrayIsNotEmpty:_cellDataArr]) {
        ...
        [cell updataWithCellArray:model codeType:3];
    }
