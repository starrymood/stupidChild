//
//  BGCouponAlreadyUsedViewController.m
//  shzTravelC
//
...
#define BtnHeight 40
@interface BGCouponAlreadyUsedViewController ()<UITableViewDelegate, UITableViewDataSource>
...
@implementation BGCouponAlreadyUsedViewController
-(UIView *)noneView {
    if (!_noneView) {
        ...
        showMsgLabel.text = @"亲，您还没有已使用的优惠券哟~";
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([Tool arrayIsNotEmpty:_cellDataArr]) {
        ...
        [cell updataWithCellArray:model codeType:2];
    }
