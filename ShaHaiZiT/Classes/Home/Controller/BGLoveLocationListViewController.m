//
//  BGLoveLocationListViewController.m
//  ShaHaiZiT
//
...
@interface BGLoveLocationListViewController ()<UICollectionViewDataSource,UICollectionViewDelegate>
...
@implementation BGLoveLocationListViewController
...
-(void)loadSubViews{
    ...
    self.navigationItem.title = @"网红时尚地标";
}
/**
 * 创建布局和collectionView
 */
- (void)setupLayoutAndCollectionView{
    ...
    locationFlowLayout.sectionInset = UIEdgeInsetsMake(15, 10, 15, 10);
    locationFlowLayout.minimumLineSpacing = 20;
    locationFlowLayout.minimumInteritemSpacing  = 12;
    locationFlowLayout.scrollDirection = UICollectionViewScrollDirectionVertical;
    
    // 创建collectionView
    UICollectionView * collectionView = [[UICollectionView alloc]initWithFrame:CGRectMake(0, SafeAreaTopHeight, SCREEN_WIDTH, SCREEN_HEIGHT-SafeAreaTopHeight) collectionViewLayout:locationFlowLayout];
