...
@implementation BGHotVideosViewController
-(UIView *)noneView {
    if (!_noneView) {
...
- (void)loadSubViews {
    ...
    self.navigationItem.title = @"热门视频";
...
- (void)loadData {
    ...
    [BGCommunityApi getVideoList:param succ:^(NSDictionary *response) {
         DLog(@"\n>>>[getVideoList sucess]:%@",response);
