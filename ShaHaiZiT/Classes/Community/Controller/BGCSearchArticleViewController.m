//
//  BGCSearchArticleViewController.m
//  shzTravelC
//
...
@interface BGCSearchArticleViewController ()<UICollectionViewDataSource,UICollectionViewDelegate,BGWaterFallLayoutDelegate>
...
@implementation BGCSearchArticleViewController
-(UIView *)noneView {
    if (!_noneView) {
...
-(void)loadData {
    ...
    [param setObject:BGGetUserDefaultObjectForKey(@"SearchKeyWord") forKey:@"post_title"];
