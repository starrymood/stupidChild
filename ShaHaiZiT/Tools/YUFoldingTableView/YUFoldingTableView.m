...
- (UIImage *)arrowImageForSection:(NSInteger )section
{
    ...
    return [UIImage imageNamed:@"home_more_selected"];
}
...
- (UIView *)normalHeaderViewWithTableView:(UITableView *)tableView section:(NSInteger)section
{
    ...
    [sectionHeaderView configWithBackgroundColor:kAppWhiteColor
                               ...
                               descriptionString:nil
                                descriptionColor:nil
                                 descriptionFont:nil
                                      arrowImage:BGImage(@"home_more_selected")
...
- (void)yuFoldingSectionHeaderTappedAtIndex:(NSInteger)index
{
    ...
    if (!currentIsOpen) {
        for (int i = 0; i<self.statusArray.count; i++) {
            ...
            YUFoldingSectionHeader *header = [self viewWithTag:100+i];
            [header.arrowImageView setHidden:YES];
        }
    }
    YUFoldingSectionHeader *header = [self viewWithTag:100+index];
    [header.arrowImageView setHidden:NO];
