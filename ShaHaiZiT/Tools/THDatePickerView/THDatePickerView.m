...
- (void)configToolView {
    ...
    [saveBtn setTitleColor:kAppMainColor forState:(UIControlStateNormal)];
    ...
    [cancelBtn setTitleColor:kApp666Color forState:(UIControlStateNormal)];
