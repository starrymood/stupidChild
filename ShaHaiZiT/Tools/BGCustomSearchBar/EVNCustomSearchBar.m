...
- (UITextField *)textField
{
    if (!_textField)
    {
        ...
        _textField.layer.borderColor = kApp999Color.CGColor;
...
//             self.textField.transform = CGAffineTransformMakeTranslation(-self.cancelButton.frame.size.width,0);
        }];
    }
...
-(void)isShowCancelButtonWithDone:(BOOL)isDone{
    
    _cancelButton.titleLabel.font = kFont(14);
    [_cancelButton setTitle:@"取消" forState:UIControlStateNormal];
    [_cancelButton setTitleColor:kApp333Color forState:UIControlStateNormal];
    _textField.backgroundColor = UIColorFromRGB(0xEBF1F6);
    [_textField setTextColor:kApp333Color];
...
-(void)setCanNotTouch{
    ...
    _cancelButton.titleLabel.font = kFont(14);
    [_cancelButton setTitle:@"取消" forState:UIControlStateNormal];
    [_cancelButton setTitleColor:kApp333Color forState:UIControlStateNormal];    _textField.backgroundColor = UIColorFromRGB(0xEBF1F6);
    [_textField setTextColor:kApp333Color];
    _textField.layer.borderWidth = 0;
